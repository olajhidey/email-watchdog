...
7.  **Summarize**: The text content is sent to the configured AI API via a POST request.
8.  **Display & Restart**: The AI's response (the summary) is printed to the console, and the application restarts the `IDLE` command to wait for the next email.
